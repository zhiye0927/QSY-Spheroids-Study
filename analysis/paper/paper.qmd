...
<<<<<<< HEAD
p_basic_characteristics <- 
plot_grid(p_raw_material,
          p_dimensions,
          labels = "AUTO")

ggsave(filename = here("analysis/paper/figures/basic_artefact_characteristics.png"),
       plot = p_basic_characteristics,
       h = 5, 
       w = 7)

knitr::include_graphics(here("analysis/paper/figures/basic_artefact_characteristics.png"))
...
>>>>>>> 91703c874fc87f1bdba5cdee3cf5912c585d3e2d
```
...
y_pos_start <- 1.06
>>>>>>> 91703c874fc87f1bdba5cdee3cf5912c585d3e2d
v_spacing <- 0.005 # The vertical gap between lines
...
# --- Annotation Layer 1: 'r' value ---
  annotate("text",
    ...
    hjust = 0,  # Left-aligns the text at x_pos
    size = 5,
    color = "#1C3041"
  ) +
  ...
  annotate("text",
    x = x_pos,
    y = y_pos_start - v_spacing, # Position below the first line
  ...
  annotate("text",
    x = x_pos,
    y = y_pos_start - (2 * v_spacing), # Position below the second line
...
```{r}
<<<<<<< HEAD
#| label: fig-UMAP-SPHARM-samples-clusters
#| fig-cap: "A. UMAP plot showing distinct clusters of shapes derived from SPHAR. B UMAP plot of SPHARM-derived shape features colored by types."


library(magick)

p_top <- ggdraw() +
  draw_image(here("analysis/paper/figures/UMAP_SPHARM_clusters.png"))

p_bottom <- ggdraw() +
  draw_image(here("analysis/paper/figures/UMAP_SPHARM_samples.png"))

# use plot_grid() to combine them.
plot_grid(
  p_top,
  p_bottom,
  ncol = 1,
...
p_panel_spharm <- plot_grid(
  ggdraw() + draw_image(here("analysis/paper/figures/UMAP_SPHARM_clusters.png")),
  ggdraw() + draw_image(here("analysis/paper/figures/UMAP_SPHARM_samples.png")),
  labels = "AUTO",
  ncol = 1
)
