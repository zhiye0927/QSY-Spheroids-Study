...
# 遍历文件夹中的文本文件
folder_path <- here("analysis/data/QSY_A")
...
write.csv(benn.output,
          here("analysis/data/benn_output.csv"), row.names = FALSE)
```
...
ggsave(here("analysis/figures/benn_ternary_plot.jpg"), 
       width = 8, 
       height = 6, 
       dpi = 300)
...
```{r}
#| label: fig-myfig
#| fig-cap: "the text of the captions. "
#| fig-height: 4

knitr::include_graphics(here::here("analysis/figures/thefigure.png"))
```
