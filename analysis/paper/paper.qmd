...
ggplot(long_data, aes(x = metric, y = value, fill = artifact)) +
  ...
  labs(
    title = "Comparison of Core, Spheroid, and Multi-poly Core Dimensions",
    x = "Dimension",
    y = "Measurement (mm)",
    fill = "Artifact"
  ) +
