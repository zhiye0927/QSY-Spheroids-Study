...
# TODO add the ideal shape graphics to p_umap_by_cluster

ggsave(plot = p_umap_by_category,
       filename = here("analysis/paper/figures/umap_by_category.png"))
...
p_umap_by_cluster <- 
ggplot(umap_data_to_plot, 
       aes(x = x, y = y)) +
  geom_point(
    data = filter(umap_data_to_plot, 
                  is_idealmodel == "no"),
    aes(color = cluster),
    alpha = 0.8,
    size = 2.5
  ...
  geom_text_repel(data = filter(umap_data_to_plot, 
                  is_idealmodel == "yes",
                  filename == "Sphere"),
    aes(color = cluster,
        label = filename),
...
ggsave(plot = p_umap_by_cluster,
       filename = here("analysis/paper/figures/umap_by_cluster.png"))
```
